...
$sql = "SELECT price FROM products WHERE id IN (SELECT prod_id FROM cart WHERE userid = $uid)"; // fetching products with userid with help of cart table.
...
<html lang="en">
  ...
  <body>
    ...
    <h3 class="order place">Congratulation, Your Order has been Placed !!</h3>
    ...
    <h6 class="order pay">You have to Pay money at the time of delivery.</h6>
